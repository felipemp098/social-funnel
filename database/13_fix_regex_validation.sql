-- =============================================================================
-- CORREÇÃO: Fix da expressão regular na validação de URL Google Sheets
-- Data: 2025-09-20
-- =============================================================================
...
COMMENT ON FUNCTION public.validate_google_sheets_url IS 'Valida URL do Google Sheets (regex corrigida)';
