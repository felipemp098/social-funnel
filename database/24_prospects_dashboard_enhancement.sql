-- =============================================================================
-- MIGRAÇÃO 24: MELHORIAS NA TABELA PROSPECTS PARA DASHBOARD
-- Adiciona campos necessários para métricas detalhadas do dashboard
-- =============================================================================

-- Adicionar campos necessários para métricas detalhadas
...
COMMENT ON COLUMN public.prospects.segment IS 'Segmento/nicho do prospect';
COMMENT ON COLUMN public.prospects.budget IS 'Orçamento disponível';
COMMENT ON COLUMN public.prospects.authority IS 'Nível de autoridade para decisão';
COMMENT ON COLUMN public.prospects.need IS 'Necessidade identificada';
COMMENT ON COLUMN public.prospects.time_frame IS 'Prazo para implementação';
COMMENT ON COLUMN public.prospects.date_prospect IS 'Data da prospecção';
COMMENT ON COLUMN public.prospects.date_scheduling IS 'Data do agendamento';
COMMENT ON COLUMN public.prospects.date_call IS 'Data da chamada';
COMMENT ON COLUMN public.prospects.status_scheduling IS 'Status do agendamento';
COMMENT ON COLUMN public.prospects.reply IS 'Resposta recebida';
COMMENT ON COLUMN public.prospects.confirm_call IS 'Confirmação da chamada';
COMMENT ON COLUMN public.prospects.complete IS 'Processo completo';
COMMENT ON COLUMN public.prospects.selling IS 'Informações de venda';
COMMENT ON COLUMN public.prospects.payment IS 'Condições de pagamento';
COMMENT ON COLUMN public.prospects.negotiations IS 'Negociações em andamento';
COMMENT ON COLUMN public.prospects.social_selling IS 'Estratégias de social selling';
COMMENT ON COLUMN public.prospects.id_sheets IS 'ID da planilha vinculada';
COMMENT ON COLUMN public.prospects.link IS 'Link relacionado';
COMMENT ON COLUMN public.prospects.closer IS 'Responsável pelo fechamento';
COMMENT ON COLUMN public.prospects.obs IS 'Observações adicionais';

-- Criar índices para performance das queries do dashboard
...
-- =============================================================================
-- FUNÇÕES PARA CÁLCULO DE MÉTRICAS DO DASHBOARD
-- =============================================================================

-- Função para verificar se é "No Show"
...
-- Função para verificar se teve resposta
...
-- Função para verificar se está em follow-up
...
-- =============================================================================
-- FUNÇÃO PRINCIPAL PARA MÉTRICAS DO DASHBOARD
-- =============================================================================
...
-- =============================================================================
-- FUNÇÃO PARA DRILL-DOWN DE MÉTRICAS
-- =============================================================================
...
COMMENT ON FUNCTION public.get_dashboard_metrics IS 'Calcula métricas agregadas para o dashboard';
COMMENT ON FUNCTION public.get_dashboard_drilldown IS 'Retorna lista detalhada de prospects para drill-down de métricas';
COMMENT ON FUNCTION public.is_no_show IS 'Verifica se um agendamento resultou em no-show';
COMMENT ON FUNCTION public.has_response IS 'Verifica se um prospect teve resposta';
COMMENT ON FUNCTION public.is_follow_up IS 'Verifica se um prospect está em follow-up';
